...
export const SearchBar = () => {
  // FUNDAMENTO: Estado para controlar el valor del input (Controlled Component)
  const [query, setQuery] = useState('');

  // FUNDAMENTO: Manejo de Eventos (Change Event)
  const handleInputChange = (e: ChangeEvent<HTMLInputElement>) => {
    setQuery(e.target.value);
    // Aquí es donde en el futuro llamaremos a la lógica de filtrado
